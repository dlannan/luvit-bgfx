...
if wwjit.os == 'Windows' then
  bgfx_api = ffi.load('lua/bgfx/bgfxWin64Release.dll')
elseif wwjit.os == 'OSX' then
  bgfx_api = ffi.load('libbgfx-shared-libDebug.dylib')
else
  bgfx_api = ffi.load('libbgfx-shared-libDebug.so')
end
...
BGFX_STATE_BLEND_ALPHA_TO_COVERAGE = 0x0000000800000000ULL
...
BGFX_STATE_POINT_SIZE_MASK = 0x00f0000000000000ULL
BGFX_STATE_MSAA = 0x0100000000000000ULL
BGFX_STATE_LINEAA = 0x0200000000000000ULL
BGFX_STATE_CONSERVATIVE_RASTER = 0x0400000000000000ULL
...
BGFX_CAPS_ALPHA_TO_COVERAGE = 0x0000000000000001ULL
BGFX_CAPS_BLEND_INDEPENDENT = 0x0000000000000002ULL
BGFX_CAPS_COMPUTE = 0x0000000000000004ULL
BGFX_CAPS_CONSERVATIVE_RASTER = 0x0000000000000008ULL
BGFX_CAPS_DRAW_INDIRECT = 0x0000000000000010ULL
BGFX_CAPS_FRAGMENT_DEPTH = 0x0000000000000020ULL
BGFX_CAPS_FRAGMENT_ORDERING = 0x0000000000000040ULL
BGFX_CAPS_GRAPHICS_DEBUGGER = 0x0000000000000080ULL
BGFX_CAPS_HIDPI = 0x0000000000000100ULL
BGFX_CAPS_HMD = 0x0000000000000200ULL
BGFX_CAPS_INDEX32 = 0x0000000000000400ULL
BGFX_CAPS_INSTANCING = 0x0000000000000800ULL
BGFX_CAPS_OCCLUSION_QUERY = 0x0000000000001000ULL
BGFX_CAPS_RENDERER_MULTITHREADED = 0x0000000000002000ULL
BGFX_CAPS_SWAP_CHAIN = 0x0000000000004000ULL
BGFX_CAPS_TEXTURE_2D_ARRAY = 0x0000000000008000ULL
BGFX_CAPS_TEXTURE_3D = 0x0000000000010000ULL
BGFX_CAPS_TEXTURE_BLIT = 0x0000000000020000ULL
BGFX_CAPS_TEXTURE_COMPARE_ALL = 0x00000000000c0000ULL
BGFX_CAPS_TEXTURE_COMPARE_LEQUAL = 0x0000000000080000ULL
BGFX_CAPS_TEXTURE_CUBE_ARRAY = 0x0000000000100000ULL
BGFX_CAPS_TEXTURE_READ_BACK = 0x0000000000200000ULL
BGFX_CAPS_VERTEX_ATTRIB_HALF = 0x0000000000400000ULL
BGFX_CAPS_VERTEX_ATTRIB_UINT10 = 0x0000000000800000ULL
...
-- copy the api into the lib table
return bgfx_api
